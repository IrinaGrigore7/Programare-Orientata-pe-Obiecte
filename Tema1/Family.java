...
public class Family extends Passenger {
	 ...
	 * @param id id-ul corespunzator entitatii
	 */
	protected Family(Person[] p, String id) {
		super(p, id);
	}
	...
	public int getPriority() {
		return 10 + getPointsForAge() + getPointsForTicket() + getPointsForSpecialNeeds() + getPointsForPriority();
	}
